      ...
      <section className="relative flex items-center justify-center py-24 px-0 overflow-hidden">
        <div className="w-full relative">
          ...
          <div className="backdrop-blur-lg bg-white/40 shadow-md w-full border-t border-b border-white/30 flex flex-col items-center text-center px-0 py-16 relative z-10">
            <h1 className="text-6xl md:text-7xl font-black leading-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-700 via-blue-700 to-pink-600 drop-shadow-lg animate-fade-in w-full">
              A Launchpad to Your Tech Career
            </h1>
            <p className="text-xl md:text-2xl font-light max-w-2xl mx-auto mb-10 text-gray-700/90 animate-fade-in delay-200 w-full">
      ...
      <section className="py-24 px-6 bg-white/80">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <OfferCard
              icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15M12 4.5a3 3 0 013 3v2.25M12 4.5a3 3 0 00-3 3v2.25M12 19.5a3 3 0 01-3-3V14.25M12 19.5a3 3 0 003-3V14.25" /></svg>}
              title="Expert Mentorship"
              description="Work directly with seasoned professionals and receive one-on-one guidance to accelerate your growth."
              className="transition-transform duration-300 hover:scale-105 hover:shadow-xl bg-white/70 rounded-2xl shadow-md p-6"
            />
            <OfferCard
              icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6m0 0v6m0-6h6m-6 0H6" /></svg>}
              title="Real-world Projects"
              description="Contribute to live projects that have a direct impact on our company and our customers."
              className="transition-transform duration-300 hover:scale-105 hover:shadow-xl bg-white/70 rounded-2xl shadow-md p-6"
            />
            <OfferCard
              icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-pink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <DomainCard
              ...
              className="transition-transform duration-300 hover:scale-105 hover:shadow-xl bg-white/80 rounded-2xl shadow-md p-6"
